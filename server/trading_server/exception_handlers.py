...
from trading_server._so._auth import UserNotFound, IncorrectPassword, InvalidToken  # type: ignore
from trading_server._so._market_logic import OutOfStock, NotEnoughMoney, ProductNotFound
